...
import it.jaschke.alexandria.BarcodeScanner.camera.CameraManager;
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.decode_succeeded:
        String barcodeStr = ((Result)message.obj).toString();
        if (AddBook.isValidEan(barcodeStr)) {
          //AlexSt: Accept only EAN-10 or EAN-13 results
          state = State.SUCCESS;
        ...
        //AlexSt: if EAN is not valid, consider decode failed
