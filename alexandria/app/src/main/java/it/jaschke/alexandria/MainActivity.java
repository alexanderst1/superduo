...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IS_TABLET = isTablet();
        //AlexSt: 2 layouts below are identical. What is the point?
        if(IS_TABLET){
        ...
        //AlexSt: in tablet mode when changing orientation from landscape to portrait
        //prevent detail fragment from being recreated as only list of books should be available
        //in portrait mode
        if(IS_TABLET
                && savedInstanceState != null
                && findViewById(R.id.right_container) == null) {
            Fragment bookDetailsFragment = fragmentManager
                    .findFragmentByTag(BookDetail.class.getSimpleName());
            if (bookDetailsFragment != null)
                fragmentManager.beginTransaction().remove(bookDetailsFragment).commit();
        }
    }
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        Fragment bookDetailsFragment = fragmentManager
                .findFragmentByTag(BookDetail.class.getSimpleName());
        if (bookDetailsFragment != null)
            transaction.remove(bookDetailsFragment);
    ...
    public void onItemSelected(String ean) {
        ...
        if(findViewById(R.id.right_container) != null){
            ...
            transaction = transaction.add(R.id.container, fragment, fragmentTag)
                    .addToBackStack(null);
        }
        transaction.commit();
    }
