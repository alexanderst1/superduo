...
public class ScoresProvider extends ContentProvider {
    private static ScoresDBHelper mDbHelper;

    public static final int INVALID_MATCH_ID = -1;

    private static final int NO_MATCHES = -1;
    ...
    {
        Cursor retCursor;
        int match = getUriMatch(uri);
        switch (match) {
            case MATCHES:
                retCursor = mDbHelper.getReadableDatabase().query(DatabaseContract.SCORES_TABLE,
            ...
            case MATCHES:
                ...
                try {
                    for(ContentValues value : values) {
                        long rowId = db.insertWithOnConflict(DatabaseContract.SCORES_TABLE, null,
