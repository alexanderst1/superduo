...
public class ScoreFetchService extends IntentService
{
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            if (JSON_data != null) {
                ...
                if (matches.length() == 0) {
                    //AlexSt: We have 'on season' now so I commented fake data out
                    //to not mix them with real data for better testability

                    //if there is no data, call the function on dummy data
                    //this is expected behavior during the off season.
                    //processJSONdata(getString(R.string.dummy_data), getApplicationContext(), false);
                    //processJSONdata(getString(R.string.dummy_data_2), getApplicationContext(), false);
                    //processJSONdata(getString(R.string.dummy_data_3), getApplicationContext(), false);
                    return;
                }
    ...
    private void processJSONdata (String JSONdata,Context mContext, boolean isReal)
    {
        ...
        final String TESTLIGA357 = "357";
        final String TESTLIGA275 = "275";
        final String TESTLIGA263 = "263";
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                ...
                if(     League.equals(PREMIER_LEAGUE)
                        ...
                        || true //AlexSt: added 'true' to show all leagues (to have more data for testing)
                        )
                {
